   ...
   aLoader = [
    ...
    { load: "edge_includes/edge.1.0.0.min.js"},
        {test: !hasJSON, yep:"edge_includes/json2_min.js"},
          { load: "Livello100_edge.js"},
          { load: "Livello100_edgeActions.js"}];
...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['478px','244px','62px','18px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/preloader2.gif','0px','0px']
   },
   {
      id:'Text2',
      type:'text',
      rect:['445px','277px','auto','auto','auto','auto'],
      text:"Peacocking . . .",
      font:['Arial, Helvetica, sans-serif',20,"rgba(69,69,69,1.00)","normal","none",""]
   }]};//simpleContent
